  ...
  featuredProjects: [
    {
      ...
      tech: ["Laravel", "Web"],
      description: "A multi-client ticketing platform to track support reports, serving multiple active clients.",
      image: "/projects/ticketing.png"
    },
    {
      title: "Train-Themed App with Chatbot",
      tech: ["Android", "Kotlin", "AI"],
      description: "An interactive application featuring train schedules, maps, and an integrated AI chatbot assistant.",
      image: "/projects/train-app.png"
    },
    {
      title: "Univariate Time Series LSTM Model",
      tech: ["Python", "TensorFlow", "Machine Learning"],
      description: "Thesis project focusing on predicting time-series data using Long Short-Term Memory (LSTM) networks.",
